...
r = os.path.dirname(__file__)  # 获取当前文件所在的文件夹路径（绝对路径）
b = os.path.dirname(r) # 获取r目录的文件夹路径
c = os.path.join(b,"aaa","111") # 在b的基础上再拼接：/aaa/111
print(r)  # 得出：/Users/luoxin/workspace/Pracitice_python/jichuzhishi/study_19
print(b) # /Users/luoxin/workspace/Pracitice_python/jichuzhishi
print(c) # /Users/luoxin/workspace/Pracitice_python/jichuzhishi/aaa/111

# os.path.abspath():通过相对路径得到绝对路径
# r = os.path.abspath('a.png')
# print(r)  # 得出：C:\Users\86176\Desktop\python\pc练习\lianxi.py\study_19\a.png

# r = os.path.abspath(__file__)  # 获取当前文件的绝对路径
# print(r)  # 得出：C:\Users\86176\Desktop\python\pc练习\lianxi.py\study_19\os02.py
#
# r = os.getcwd()  # 与os.path.dirname()相同
# print(r)  # 得出：C:\Users\86176\Desktop\python\pc练习\lianxi.py\study_19
#
# # os.path.split(path):拆分路径返回到一个元组中，得到文件名
