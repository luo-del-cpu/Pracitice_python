...
#     print(path)  # 打印当前路径：C:\Users\86176\Desktop\python\pc练习\lianxi.py\文件操作
#     print(type(path))  # 返回的是一个str类型
#     path_1 = os.path.join(path, 'a.png')
#     print(path_1)  # 打印拼接后的路径：C:\Users\86176\Desktop\python\pc练习\lianxi.py\文件操作\a.png
...
with open(r'C:\Users\86176\Desktop\python\test.png', 'rb') as stream:
    ...
    print(stream.name)  # 打印当前stream的路径和文件名：C:\Users\86176\Desktop\python\test.png
    file = stream.name
